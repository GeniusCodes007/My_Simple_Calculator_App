...
class Solving(Ui_MainWindow):
    ...
    def ans(self):
        ...
        elif self.operator == "r": self.answer = AdvancedBasicMethods().roots(self.val_1, self.val_2)
...
#Yet to touch
            ...
            self.answer = self.sine(self.val_2, self.val_1)
            ...
            self.answer = self.cos(self.val_2,self.val_1)
            self.result_display.display(f"{self.answer:.5f}")
            self.number_input.setText(f"{self.answer:.5f}")
            ...
            self.answer = self.tan(self.val_2,self.val_1)
            self.result_display.display(f"{self.answer:.5f}")
            self.number_input.setText(f"{self.answer:.5f}")
            ...
            self.answer = self.val_1 * self.arc_sine(self.val_2)
            self.result_display.display(f"{self.answer:.5f}")
            self.number_input.setText(f"{self.answer:.5f}")
            ...
            self.answer = self.val_1 * self.arc_cosine(self.val_2)
            self.result_display.display(f"{self.answer:.5f}")
            self.number_input.setText(f"{self.answer:.5f}")
            ...
            self.answer = self.val_1 * self.arc_tangent(self.val_2)
            self.result_display.display(f"{self.answer:.5f}")
            self.number_input.setText(f"{self.answer:.5f}")
        ...
        #OUTSTANDINGS
            ...
            self.answer = self.factorial(self.val_1)
            self.result_display.display(f"{self.answer:.5f}")
            self.number_input.setText(f"{self.answer:.5f}")
